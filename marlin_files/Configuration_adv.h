 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       800        // (mA) RMS current. Multiply by 1.414 for peak current. // EDIT for Bones
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       800 // EDIT for Bones
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       800 // EDIT for Bones
    #define Z_CURRENT_HOME  Z_CURRENT
    #define Z_MICROSTEPS      1 // Changed for Bones, disabled, check DEFAULT_AXIS_STEPS_PER_UNIT
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      800 // EDIT for Bones
    #define E0_MICROSTEPS    16
