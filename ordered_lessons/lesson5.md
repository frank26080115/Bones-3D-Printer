...
In the 3D model of the printer, these are named "side rods". These are **linear rods**. These rods are made of hardened and polished steel, with a very precise diameter, with a very smooth surfaces, and made extremely straight. This means when it rotates, it will not wobble, and when something slides along the rod, it will be a smooth motion without wobbling as well.
...
I say these brass bushings are special because they use self-lubricating graphite, which keeps the motion smooth and the durability of the bushing high. These should last many years and do not require you to add lubrication.
...
Let's verify this against the Hemera's datasheet. 84.7496 steps per 3.326mm, means 25.48 steps per mm. If you read the Hemera's datasheet, it specifies that it's 408 steps per mm under but under 16x microsteps. <nobr> 25.48 * 16 = 407.7 </nobr> so we are pretty close! Remember, this calculation is done assuming a lot of things are under perfect ideal conditions.
